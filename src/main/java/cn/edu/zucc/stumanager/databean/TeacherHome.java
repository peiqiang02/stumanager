 ...
 * @see cn.edu.zucc.stumanager.databean.Teacher
...
public class TeacherHome {
	...
	public Teacher findById(int id) {
		...
		try {
			Teacher instance = (Teacher) sessionFactory.getCurrentSession()
					.get("cn.edu.zucc.stumanager.databean.Teacher", id);
			if (instance == null) {
	...
	public List findByExample(Teacher instance) {
		...
		try {
			List results = sessionFactory.getCurrentSession().createCriteria("cn.edu.zucc.stumanager.databean.Teacher")
