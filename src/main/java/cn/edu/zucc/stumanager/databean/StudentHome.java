 ...
 * @see cn.edu.zucc.stumanager.databean.Student
...
public class StudentHome {
	...
	public Student findById(int id) {
		...
		try {
			Student instance = (Student) sessionFactory.getCurrentSession()
					.get("cn.edu.zucc.stumanager.databean.Student", id);
			if (instance == null) {
	...
	public List findByExample(Student instance) {
		...
		try {
			List results = sessionFactory.getCurrentSession().createCriteria("cn.edu.zucc.stumanager.databean.Student")
