 ...
 * @see cn.edu.zucc.stumanager.databean.Course
...
public class CourseHome {
	...
	public Course findById(int id) {
		...
		try {
			Course instance = (Course) sessionFactory.getCurrentSession().get("cn.edu.zucc.stumanager.databean.Course",
					id);
			if (instance == null) {
	...
	public List findByExample(Course instance) {
		...
		try {
			List results = sessionFactory.getCurrentSession().createCriteria("cn.edu.zucc.stumanager.databean.Course")
