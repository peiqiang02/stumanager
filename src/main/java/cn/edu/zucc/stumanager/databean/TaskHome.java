 ...
 * @see cn.edu.zucc.stumanager.databean.Task
...
public class TaskHome {
	...
	public Task findById(java.lang.Integer id) {
		...
		try {
			Task instance = (Task) sessionFactory.getCurrentSession().get("cn.edu.zucc.stumanager.databean.Task", id);
			if (instance == null) {
	...
	public List findByExample(Task instance) {
		...
		try {
			List results = sessionFactory.getCurrentSession().createCriteria("cn.edu.zucc.stumanager.databean.Task")
